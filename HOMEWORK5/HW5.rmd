...
#range(1.75,5). type is set to "n" meaning the plot will not produce any points or lines
#axes is set to F meaning the x and y axis calibrations will not be visible 
...
# This pasted 7 new figures: text 7,8,9,10,11,12,13 on the plot positioned beside the plot symbols 7-13.
...
### Your code here
```{r}
boxplot(Sepal.Width~Species,data=iris, main="SEPAL WIDTH IN DIFFERENT SPECIES", Xlab="Sepal.Width",ylab="Species",horizontal =TRUE, par(cex.axis =0.7))
...
barplot(diamonds_color, main="BAR PLOT OF DIAMONDS COLOR", xlab="diamond colors")
...
### Your code here
```{r}
mosaicplot(table(diamonds$cut,diamonds$clarity), main = "MOSAIC PLOT OF CUT AND CLARITY")
...
#The data life cycle provides a detailed, systematic approach for dealing with data. Every stage of the data life cycle 
#corresponds to certain tasks that need to be carried out. While there are many variations of the data life cycle that
#which can be employed, certain important tasks such as data cleaning, analysis are compulsory to ensure that data is correctly utilized to generate insights
#Also the data life cycle needs to be employed in a thorough manner because this ensures that documentation is available for future use , further exploration and discovery. 
